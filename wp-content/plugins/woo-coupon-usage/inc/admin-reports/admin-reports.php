...
if ( !function_exists( 'wcusage_admin_reports_page_html' ) ) {
  ...
  <h1><?php 
        echo  __( "Admin Reports & Analytics", "woo-coupon-usage" ) ;
        ?></h1>

  <p style="color: #333;">
    <i class="fas fa-info-circle"></i> <?php 
        echo  __( 'With admin reports, you can view statistics and analytics for all your coupons and affiliates.', 'woo-coupon-usage' ) ;
  ...
  <div>
      ...
      onsubmit="return false;" style="background: linear-gradient(#fefefe, #f6f6f6); border: 1px solid #f3f3f3; box-shadow: 0px 0px 4px #d0d0d0;">

      <h2 style="margin: 0 auto 20px auto; display: block; font-size: 25px; text-align: center;"><?php 
        echo  __( "Generate a new admin report", "woo-coupon-usage" ) ;
        ?>:</h2>
      ...
      <p style="padding-top: 0; margin-top: 0;">
        ...
        ?>: <input type="date"
          min="<?php 
        echo  $wcu_orders_date_min ;
        ?>" max="<?php 
        echo  $wcu_orders_date_max ;
        ?>"
          id="wcu-orders-start" name="wcu_monthly_orders_start"
          value="<?php 
        echo  $wcu_monthly_orders_start ;
        ?>">
        </span>
      ...
      <p style="color: #959595;">
        <?php 
            echo  __( "Free version can display reports for up to the past 1 month.", "woo-coupon-usage" ) ;
            ?>
        <br/>
        <?php 
            echo  __( "Unlimited date range selection is available with the", "woo-coupon-usage" ) ;
            ?> <a href="<?php 
            echo  get_admin_url() ;
      ...
      <?php 
        ...
        if ( !wcu_fs()->can_use_premium_code() ) {
            ...
            echo  __( "Date comparisons and more filters are available with the", "woo-coupon-usage" ) ;
            ?> <a href="<?php 
            echo  get_site_url() ;
            ?>/wp-admin/admin.php?page=wcusage-pricing&trial=true" style="color: green;">PRO version</a>.</span><?php 
        }
        ...
        jQuery(document).ready(function(){
          ...
          jQuery("#wcu_report_compare_to").change(function() {
        ...
        echo  __( "Compare with another date range", "woo-coupon-usage" ) ;
        ?>.</strong></p>
        ...
        ?>: <input type="date" <?php 
        ?> value="<?php 
        echo  $wcu_monthly_orders_start_compare ;
        ?>">
            </span>
            <span class="wcu-order-filters-space">&nbsp;</span>
            <span class="wcu-order-filters-field wcu-order-filters-field-date">
        ...
        ?>: <input type="date" <?php 
        ?> value="<?php 
        echo  $wcu_monthly_orders_end_compare ;
        ?>">
            </span>
          </p>
        ...
        echo  __( "Only show coupons where sales have", "woo-coupon-usage" ) ;
        ?>:</strong>
                <select <?php 
        ?>>
                  <option value="both"><?php 
        echo  __( "Increased or Decreased", "woo-coupon-usage" ) ;
        ?></option>
                  <option value="more"><?php 
        echo  __( "Increased", "woo-coupon-usage" ) ;
        ?></option>
                  <option value="less"><?php 
        echo  __( "Decreased", "woo-coupon-usage" ) ;
        ?></option>
                </select>
                <?php 
        echo  __( "by more than", "woo-coupon-usage" ) ;
        ?>
      ...
      <p><input type="checkbox" id="wcu_report_users_only" name="wcu_report_users_only" value="true" style="margin-top: -2px;"> <strong><?php 
        echo  __( "Only show coupons assigned to an affiliate user.", "woo-coupon-usage" ) ;
        ?></strong></p>
      ...
      <?php 
        $extrafilters = array(
            array( "wcu_report_show_sales", ".wcu-order-filtersales-field", __( "Sales", "woo-coupon-usage" ) ),
            array( "wcu_report_show_commission", ".wcu-order-filtercommission-field, .wcu-order-filterunpaid-field", __( "Commission", "woo-coupon-usage" ) ),
            array( "wcu_report_show_url", ".wcu-order-filterconversions-field", __( "Referral URLs", "woo-coupon-usage" ) ),
            array( "wcu_report_show_products", "", __( "Products", "woo-coupon-usage" ) )
        );
        ?>
      <?php 
    ...
    <div class="admin-report-form-row" style="border-left: 1px solid #f3f3f3;">
      ...
      <div class="wcu-report-filterusage-field">
        ...
        echo  __( "Equal or More", "woo-coupon-usage" ) ;
        ?></option>
              <option value="more"><?php 
        echo  __( "More", "woo-coupon-usage" ) ;
        ?></option>
              <option value="less or equal"><?php 
        echo  __( "Equal or Less", "woo-coupon-usage" ) ;
        ?></option>
              <option value="less"><?php 
        echo  __( "Less", "woo-coupon-usage" ) ;
        ?></option>
              <option value="equal"><?php 
        echo  __( "Equal", "woo-coupon-usage" ) ;
        ?></option>
            </select>
            than
    ...
    <p style="margin-top: 20px;">
      ...
      <button class="ordersfilterbutton wcu-button-search-report-admin" type="submit" id="wcu-monthly-orders-button" name="submitmonthlyordersfilter">
        <?php 
        echo  __( "GENERATE REPORT", "woo-coupon-usage" ) ;
  ...
  <div class="wcu-loading-image wcu-loading-stats" style="display: none;">
    ...
    <p style="margin: 0;font-size:;font-weight: bold; margin-top: 10px; width: 200px;"><br/><?php 
        echo  __( "Generating Report", "woo-coupon-usage" ) ;
        ?>...</p>
    <br/>

    <span style="margin-top: 25px; font-size: 12px; color: #909090;"><br/>
      <?php 
        echo  __( "This may take a few seconds...", "woo-coupon-usage" ) ;
        ?><br/>
      <?php 
        echo  __( "It will take longer if you select a large date range, or have lots of orders and coupons.", "woo-coupon-usage" ) ;
        ?>
    </span>
  </div>
  ...
  <div class="loaded-stats-wrapper" style="display: none;">
    ...
    <a id="generate-new-report" href="#" onclick="return false;" style="text-decoration: none; font-weight: bold;">
      <?php 
        echo  __( "GENERATE NEW REPORT", "woo-coupon-usage" ) ;
    ...
    <h2 id="report-complete-title">Report Complete!</h2>
      ...
      <div class="wcusage-reports-stats-section-sales">
        ...
        echo  __( "Total Sales", "woo-coupon-usage" ) ;
        ?>:</span>
                <?php 
        echo  wcusage_get_currency_symbol() ;
        ?><span class="total-sales">0.00</span>
            ...
            <div class="wcusage-info-box wcusage-info-box-discounts">
              <p>
                <span class="wcusage-info-box-title"><?php 
        echo  __( "Total Discounts", "woo-coupon-usage" ) ;
        ?>:</span>
                <?php 
        echo  wcusage_get_currency_symbol() ;
        ...
        <div class="wcusage-reports-stats-section-commission">
          ...
          <fieldset class="wcusage-reports-stats-section wcusage-reports-stats-section-commission">
            ...
            <div class="wcusage-info-box wcusage-info-box-dollar">
              <p>
                <span class="wcusage-info-box-title"><?php 
        echo  __( "Total Commission", "woo-coupon-usage" ) ;
        ?>:</span>
                <?php 
        echo  wcusage_get_currency_symbol() ;
        ...
        ?> <?php 
        echo  __( "Unpaid Commission", "woo-coupon-usage" ) ;
        ?>:</span>
                <?php 
        echo  wcusage_get_currency_symbol() ;
        ...
        ?> <?php 
        echo  __( "Pending Payouts", "woo-coupon-usage" ) ;
        ?>:</span>
                <?php 
        echo  wcusage_get_currency_symbol() ;
        ?><span class="pending-commission">0</span>
                <span class="all-time-side-text" style="font-size: 12px; font-weight: bold; display: inline;"><a href="/wp-admin/admin.php?page=wcusage_payouts" style="text-decoration: none;">Pay Now <i class="fas fa-arrow-right"></i></a></span>
              </p>
            </div>
        ...
        <div class="wcusage-reports-stats-section-url">
          ...
          <fieldset class="wcusage-reports-stats-section">
            ...
            <div class="wcusage-info-box wcusage-info-box-clicks">
              <p>
                <span class="wcusage-info-box-title"><?php 
        echo  __( "Total Clicks", "woo-coupon-usage" ) ;
        ?>:</span>
            ...
            <div class="wcusage-info-box wcusage-info-box-convert">
              <p>
                <span class="wcusage-info-box-title"><?php 
        echo  __( "Total Conversions", "woo-coupon-usage" ) ;
        ?>:</span>
            ...
            <div class="wcusage-info-box wcusage-info-box-percent">
              <p>
                <span class="wcusage-info-box-title"><?php 
        echo  __( "Conversion Rate", "woo-coupon-usage" ) ;
        ?>:</span>
      ...
      <div id="search-block" style="display: inline-block;">
        ...
        echo  __( "Search Coupons", "woo-coupon-usage" ) ;
      ...
      <?php 
        ...
        <?php 
            ...
            ?>
        <script src="<?php 
            echo  WCUSAGE_UNIQUE_PLUGIN_URL . 'js/jquery.table2excel.min.js' ;
            ?>"></script>
        <script>
        jQuery( document ).ready(function() {
      ...
      <span <?php 
        ...
        value="<?php 
        echo  __( "Download CSV", "woo-coupon-usage" ) ;
        ?> &#x025B8;"
        <?php 
        if ( !wcu_fs()->can_use_premium_code() ) {
      ...
      <a href="#!" id="sort-by-usage" class="sort-link"><?php 
        echo  __( "Usage", "woo-coupon-usage" ) ;
        ?></a>
      | <a href="#!" id="sort-by-orders" class="sort-link"><?php 
        echo  __( "Orders", "woo-coupon-usage" ) ;
        ?></a>
      | <a href="#!" id="sort-by-discounts" class="sort-link"><?php 
        echo  __( "Discounts", "woo-coupon-usage" ) ;
        ?></a>
      </span>
      ...
      | <a href="#!" id="sort-by-commission" class="sort-link"><?php 
        ...
        if ( $wcusage_field_tracking_enable && wcu_fs()->can_use_premium_code() ) {
          ...
          | <a href="#!" id="sort-by-unpaid" class="sort-link"><?php 
            echo  __( "Unpaid", "woo-coupon-usage" ) ;
            ?></a>
          | <a href="#!" id="sort-by-pending" class="sort-link"><?php 
            echo  __( "Pending", "woo-coupon-usage" ) ;
            ?></a>
        <?php 
        }
  ...
  jQuery(document).ready(function(){
    ...
    jQuery('#inpSearchBtn').click(function(){
    ...
    jQuery('#generate-new-report').click(function(){
       jQuery('.loaded-stats-wrapper').css('display', 'none');
    });
    jQuery('.wcu-button-search-report-admin').click(function(){
  ...
  <div class="loaded-stats-wrapper">
    ...
    <div class="wrap loaded-stats" id="content"  style="margin: 0;">
      ...
      jQuery(document).ready(function(){
        ...
        jQuery('.ordersfilterbutton').click(function() {
          ...
          var data = {
            ...
            _ajax_nonce: '<?php 
        echo  wp_create_nonce( 'wcusage_admin_ajax_nonce' ) ;
        ?>',
        ...
        ?>
          ...
          jQuery.ajax({
              ...
              url: ajaxurl,
              data: data,
              success: function(data){ jQuery('.show_data').html(data); }
          });
...
if ( !function_exists( 'wcusage_get_admin_report_data' ) ) {
    ...
    )
    {
        ...
        ?>
    <?php 
        $reportscripthtml = "<div class='report-complete-box'><h2>" . __( "Report Complete!", "woo-coupon-usage" ) . "</h2><p>";
        $reportscripthtml .= "<i class='fas fa-check-circle'></i> " . __( "Report created for", "woo-coupon-usage" ) . " " . date_i18n( 'j F Y', strtotime( $wcu_orders_start ) ) . " to " . date_i18n( 'j F Y', strtotime( $wcu_orders_end ) );
        
        if ( $wcu_compare == "true" ) {
            $reportscripthtml .= "<br/><i class='fas fa-check-circle'></i> " . __( "Comparing with date period", "woo-coupon-usage" ) . " " . date_i18n( 'F j, Y', strtotime( $wcu_orders_start_compare ) ) . " " . __( "to", "woo-coupon-usage" ) . " " . date_i18n( 'F j, Y', strtotime( $wcu_orders_end_compare ) );
            
            if ( $wcu_orders_filtercompare_type == "both" && $wcu_orders_filtercompare_amount == 0 ) {
            } else {
                $reportscripthtml .= "<br/><i class='fas fa-check-circle'></i> " . __( "Showing coupons where sales have", "woo-coupon-usage" ) . " " . $comparetypetext . " " . __( "by more than", "woo-coupon-usage" ) . " " . $wcu_orders_filtercompare_amount . "%.";
            }
        ...
        foreach ( $arrayextrafilters as $filter ) {
            ...
            if ( $filter[1] == "more or equal" && $filter[2] == 0 || $filter[1] == "more or equal" && $filter[2] == "" ) {
                ...
                $reportscripthtml .= "<br/><i class='fas fa-check-circle'></i> " . __( "Showing coupons where", "woo-coupon-usage" ) . " " . $filter[0] . " " . __( "is", "woo-coupon-usage" ) . " " . $filter[1] . " " . __( "than", "woo-coupon-usage" ) . " " . $filter[3] . ".";
            }
        
        }
        if ( $wcu_report_users_only == "true" ) {
            $reportscripthtml .= "<br/><i class='fas fa-check-circle'></i> " . __( "Only showing coupons that are assigned to an affiliate user.", "woo-coupon-usage" );
        }
      ...
      >
          ...
          <td colspan="7">
            <span class="wcu-coupon-name" style="font-size: 20px; margin-bottom: 10px; display: block; font-weight: bold;">
              <a href="<?php 
                ...
                echo  __( "View Affiliate Dashboard", "woo-coupon-usage" ) ;
                ?>"><?php 
                echo  $coupon_code ;
                ?></a>
              <span style="font-size: 10px;" ><a href="<?php 
                echo  get_edit_post_link( $coupon_id ) ;
                ?>" target="_blank" title="<?php 
                echo  __( "Edit Coupon", "woo-coupon-usage" ) ;
          ...
          <tr class="coupon-data-row-head" style="padding: 0 15px 0px 15px; margin: 0px 0;">
            ...
            <td class="wcu-r-td wcu-r-td-id" style="min-width: 90px;"><?php 
                echo  __( "Coupon ID", "woo-coupon-usage" ) ;
            ...
            <td class="wcu-r-td wcu-r-td-120 wcu-r-td-affiliate"><?php 
                echo  __( "Affiliate User", "woo-coupon-usage" ) ;
            ...
            <td class="wcu-r-td wcu-r-td-120 wcu-r-td-sales"><?php 
                    echo  __( "Sales", "woo-coupon-usage" ) ;
            ...
            <?php 
              ...
              <?php 
                ...
                <td class="wcu-r-td wcu-r-td-120 wcu-r-td-pending"><?php 
                        echo  __( "Pending Payout", "woo-coupon-usage" ) ;
            ...
            <?php 
              ...
              <td class="wcu-r-td wcu-r-td-120 wcu-r-td-sales" id="total-sales-<?php 
                ...
                <?php 
                    ...
                    echo  str_replace( ',', '', number_format( $total_orders, 2 ) ) ;
                    ?></span>
                <?php 
              ...
              <td class="wcu-r-td wcu-r-td-120 wcu-r-td-discounts" id="total-discounts-<?php 
                ...
                <?php 
                    ...
                    echo  str_replace( ',', '', number_format( $full_discount, 2 ) ) ;
                    ?></span>
                <?php 
            ...
            <?php 
              ...
              <td class="wcu-r-td wcu-r-td-120 wcu-r-td-commission" id="total-commission-<?php 
                ...
                <?php 
                    ...
                    echo  str_replace( ',', '', number_format( $total_commission, 2 ) ) ;
                    ?></span>
                <?php 
              ...
              <?php 
                ...
                <td class="wcu-r-td wcu-r-td-120 wcu-r-td-unpaid">
                  <?php 
                        ...
                        echo  str_replace( ',', '', number_format( $unpaid_commission, 2 ) ) ;
                        ?></span>
                </td>
                ...
                <td class="wcu-r-td wcu-r-td-120 wcu-r-td-pending">
                  <?php 
                        ...
                        echo  str_replace( ',', '', number_format( $pending_payments, 2 ) ) ;
                        ?></span>
                </td>
            ...
            <?php 
              ...
              <tr class="coupon-data-row-head wcu-r-td-products" style="padding: 0 15px 0px 15px; margin: 0px 0;">
                  <td class="wcu-r-td wcu-r-td-120 break wcu-r-td-clicks"><?php 
                    echo  __( "Referral URL Clicks", "woo-coupon-usage" ) ;
                  ...
                  <td class="wcu-r-td wcu-r-td-120 break wcu-r-td-conversions"><?php 
                    echo  __( "Referral URL Conversions", "woo-coupon-usage" ) ;
            ...
            <?php 
              ...
              <tr class="coupon-data-row-head wcu-r-td-products" style="padding: 0 15px 0px 15px; margin: 0px 0;">
                  <td class="wcu-r-td wcu-r-td-120 break wcu-r-td-products"><?php 
                    echo  __( "Products", "woo-coupon-usage" ) ;
                ...
                <?php 
                    ...
                    if ( $list_of_products ) {
                        foreach ( $list_of_products as $key => $value ) {
                            ...
                            echo  "&#8226; " . $value . " x " . $product->get_name() . "<br/>" ;
                        }
                    } else {
...
if ( !function_exists( 'wcusage_get_admin_report_scripts_sorting' ) ) {
    function wcusage_get_admin_report_scripts_sorting()
    {
        ?>
    <script>
    jQuery( "#sort-by-usage" ).click(function() {
      var divList = jQuery(".coupon-item-box");
      divList.sort(function(a, b){
          return jQuery(b).data("usage")-jQuery(a).data("usage")
      });
    ...
    jQuery( "#sort-by-orders" ).click(function() {
      var divList = jQuery(".coupon-item-box");
      divList.sort(function(a, b){
    ...
    jQuery( "#sort-by-commission" ).click(function() {
      var divList = jQuery(".coupon-item-box");
      divList.sort(function(a, b){
    ...
    jQuery( "#sort-by-discounts" ).click(function() {
      var divList = jQuery(".coupon-item-box");
      divList.sort(function(a, b){
    ...
    jQuery( "#sort-by-unpaid" ).click(function() {
      var divList = jQuery(".coupon-item-box");
      divList.sort(function(a, b){
    ...
    jQuery( "#sort-by-pending" ).click(function() {
      var divList = jQuery(".coupon-item-box");
      divList.sort(function(a, b){
...
if ( !function_exists( 'wcusage_get_admin_report_scripts_remove_row' ) ) {
    ...
    function wcu_report_remove_col() {
      ...
      jQuery( ".hide-col-id" ).click(function() {
        jQuery( ".wcu-r-td-id" ).remove();
      });
      jQuery( ".hide-col-affiliate" ).click(function() {
        jQuery( ".wcu-r-td-affiliate" ).remove();
      });
      jQuery( ".hide-col-usage" ).click(function() {
        jQuery( ".wcu-r-td-usage" ).remove();
      });
      jQuery( ".hide-col-sales" ).click(function() {
        jQuery( ".wcu-r-td-sales" ).remove();
      });
      jQuery( ".hide-col-commission" ).click(function() {
        jQuery( ".wcu-r-td-commission" ).remove();
      });
      jQuery( ".hide-col-discounts" ).click(function() {
        jQuery( ".wcu-r-td-discounts" ).remove();
      });
      jQuery( ".hide-col-unpaid" ).click(function() {
        jQuery( ".wcu-r-td-unpaid" ).remove();
      });
      jQuery( ".hide-col-pending" ).click(function() {
        jQuery( ".wcu-r-td-pending" ).remove();
      });
      jQuery( ".hide-col-clicks" ).click(function() {
        jQuery( ".wcu-r-td-clicks" ).remove();
      });
      jQuery( ".hide-col-conversions" ).click(function() {
        jQuery( ".wcu-r-td-conversions" ).remove();
      });
      jQuery( ".hide-col-conversion-rate" ).click(function() {
        jQuery( ".wcu-r-td-conversion-rate" ).remove();
      });
      jQuery( ".hide-col-products" ).click(function() {
